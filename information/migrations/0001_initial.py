    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(default='', upload_to='image/%Y/%m', verbose_name='用户头像')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('changeName', models.CharField(max_length=30, verbose_name='轮播图名')),
                ('changeImage', models.ImageField(default='', upload_to='change/%Y/%m')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('choice', models.SmallIntegerField(choices=[(1, '注册'), (0, '找回密码')], verbose_name='选择')),
